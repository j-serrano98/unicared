    ...
    <div className="container-xl lg:container m-auto py-7">
      <section class="bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-screen-md text-center lg:py-16 lg:px-12">
            ...
            <h1 class="mb-4 text-4xl font-bold tracking-tight leading-none text-gray-900 lg:mb-6 md:text-5xl xl:text-6xl dark:text-white">Seccion en Construccion</h1>
            <p class="font-light text-gray-500 md:text-lg xl:text-xl dark:text-gray-400">Estamos trabajando para brindarte una mejor experiencia</p>
        </div>
      </section>
      <GoBackButton />
    </div>
